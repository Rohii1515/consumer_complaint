...
from consumer_complaint.entity.config_entity import DataIngestionConfig, TrainingPipelineConfig, DataValidationConfig, \
...
from consumer_complaint.constant.training_pipeline_config import *
from consumer_complaint.constant import TIMESTAMP
from consumer_complaint.utils import create_directories
...
from consumer_complaint.entity.metadata_entity import DataIngestionMetadata
from consumer_complaint.constant.model import S3_MODEL_DIR_KEY, S3_MODEL_BUCKET_NAME
...
class FinanceConfig:
    ...
    def __init__(self, pipeline_name=PIPELINE_NAME, timestamp=TIMESTAMP):
        """
        Organization: _____ Private Limited
