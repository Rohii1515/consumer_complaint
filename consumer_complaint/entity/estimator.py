...
import shutil
import os
from consumer_complaint.constant.model import MODEL_SAVED_DIR
import time
from typing import List, Optional
import re
from abc import abstractmethod, ABC
from consumer_complaint.config.aws_connection_config import AWSConnectionConfig
...
class ConsumerComplaintEstimator:
...
class S3ConsumerEstimator(ConsumerComplaintEstimator, S3Estimator):
    ...
    def get_latest_model_path(self) -> str:
        ...
        return ConsumerComplaintEstimator.get_latest_model_path(self)
