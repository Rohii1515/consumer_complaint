...
from consumer_complaint.entity.artifact_entity import DataIngestionArtifact
from consumer_complaint.entity.config_entity import DataValidationConfig
...
from consumer_complaint.entity.artifact_entity import DataValidationArtifact
...
class DataValidation(FinanceDataSchema):
    ...
    def __init__(self,
        ...
        try:
            ...
            raise ConsumerException(e, sys) from e
