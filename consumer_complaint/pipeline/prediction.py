from consumer_complaint.constant.model import S3_MODEL_BUCKET_NAME, S3_MODEL_DIR_KEY
from consumer_complaint.constant.prediction_pipeline_config.file_config import S3_DATA_BUCKET_NAME, PYSPARK_S3_ROOT
from consumer_complaint.entity.config_entity import PredictionPipelineConfig
from consumer_complaint.entity.schema import ConsumerDataSchema
from pyspark.sql import DataFrame
from consumer_complaint.cloud_storage import SimpleStorageService
...
from consumer_complaint.entity.estimator import S3ConsumerEstimator
...
class PredictionPipeline:
    ...
    def __init__(self, pipeline_config=PredictionPipelineConfig()) -> None:
        ...
        self.schema: ConsumerDataSchema = ConsumerDataSchema()
    ...
    def start_batch_prediction(self):
        try:
            ...
            estimator = S3ConsumerEstimator(bucket_name=S3_MODEL_BUCKET_NAME, s3_key=S3_MODEL_DIR_KEY)
